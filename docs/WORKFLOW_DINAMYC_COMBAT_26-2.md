...
> Este archivo pertenece al proyecto **Dinamyc Combat**. Cambios aquí solo afectan a este proyecto.
...
| Dato | Valor |
|---|---|
| Mod ID (`gradle.properties`) | `dinamyc_combat` |
| Clase principal | `DinamycCombatNeoForge` |
| Display name (Title Case) | `Dinamyc Combat` |
| Versiones de Minecraft | `26.2` |
| Rama | `minecraft/26.2/neoforge-26.2.0.32-beta/production` |

### Notas específicas de este mod

- **Clase principal real**: `DinamycCombatNeoForge` (naming atípico, respetando el mod_id existente; no aplicar la regla PascalCase genérica aquí).
## Convenciones de nomenclatura

| Convención | Uso | Ejemplo |
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `dinamyc_combat` |
| **PascalCase** | Clases Java principales | `DinamycCombatNeoForge` |
| **camelCase** | Variables, métodos, config keys | `dinamyc_combatConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Dinamyc Combat` |
