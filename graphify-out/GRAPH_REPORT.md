...
## Corpus Check
- 181 files · ~168,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 803 nodes · 1488 edges · 42 communities (39 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b2e4a63`
...
- `AttributesContainer` --references--> `WeaponAttributes`  [EXTRACTED]
  src/main/java/com/skd/dinamyccombat/api/AttributesContainer.java → src/main/java/com/skd/dinamyccombat/api/WeaponAttributes.java
- `WeaponAttributes` --references--> `ConditionalTrailAppearance`  [EXTRACTED]
  src/main/java/com/skd/dinamyccombat/api/WeaponAttributes.java → src/main/java/com/skd/dinamyccombat/api/fx/ConditionalTrailAppearance.java
- `SyncFormat` --references--> `WeaponAttributes`  [EXTRACTED]
  src/main/java/com/skd/dinamyccombat/logic/WeaponRegistry.java → src/main/java/com/skd/dinamyccombat/api/WeaponAttributes.java
- `WeaponRegistry` --references--> `WeaponAttributes`  [EXTRACTED]
  src/main/java/com/skd/dinamyccombat/logic/WeaponRegistry.java → src/main/java/com/skd/dinamyccombat/api/WeaponAttributes.java
...
Cohesion: 0.12
Nodes (14): AttributeModifier, DataComponentPatch, Multimap, Shadow, Gson, ItemStack, WeaponAttributesHelper, ItemStackMixin (+6 more)

### Community 1 - "Packets.java"
Cohesion: 0.09
Nodes (25): CustomPacketPayload, TrailAppearance, AnimatedHand, MAIN_HAND, OFF_HAND, TWO_HANDED, from(), Ack (+17 more)

### Community 2 - "LivingEntityMixin.java"
Cohesion: 0.07
Nodes (33): Inventory, NonNullList, Redirect, InventoryUtil, ItemStack, Player, ConfigurableKnockback, CallbackInfoReturnable (+25 more)
...
Cohesion: 0.07
Nodes (15): AttackHand, ItemStack, ComboState, EntityPlayer_DinamycCombat, Nullable, WeaponAttributes, ItemStackNBTWeaponAttributes, Nullable (+7 more)
...
Cohesion: 0.08
Nodes (23): AnimationController, AnimationData, AnimationSetter, Avatar, FirstPersonConfiguration, FirstPersonMode, PlayerAnimationController, PlayState (+15 more)
...
Cohesion: 0.10
Nodes (21): DataComponentType, DeferredHolder, ServerGamePacketListenerImpl, SoundEvent, DinamycDataComponents, DeferredRegister, Identifier, IEventBus (+13 more)
...
Cohesion: 0.11
Nodes (16): Codec, MapCodec, ParticleOptions, Identifier, RegistryFriendlyByteBuf, StreamCodec, WeaponAttributesIdComponent, DinamycParticles (+8 more)
...
Cohesion: 0.13
Nodes (19): Direction, ClientConfig, BooleanValue, Builder, ConfigValue, DoubleValue, EnumValue, IntValue (+11 more)

### Community 14 - "ParticlePlacement"
Cohesion: 0.13
Nodes (7): Color, ConditionalTrailAppearance, Identifier, ParticlePlacement, Identifier, Part, TrailConfig
...
Cohesion: 0.18
Nodes (10): [0.0.0-beta.1] - 2026-08-02, [1.0.0] - 2026-08-02, [1.0.1] - 2026-08-02, [1.0.2] - 2026-08-05, Added, Added, Change, Changed (+2 more)
...
Cohesion: 0.17
Nodes (10): ResourceManager, AttributesContainer, Encoded, Gson, Identifier, ItemStack, Logger, SyncFormat (+2 more)

## Knowledge Gaps
- **64 isolated node(s):** `FORWARD_BOX`, `VERTICAL_PLANE`, `HORIZONTAL_PLANE`, `NOT_DUAL_WIELDING`, `DUAL_WIELDING_ANY` (+59 more)
...
- **Why does `WeaponAttributes` connect `PlayerAttackHelper` to `WeaponAttributes`, `Attack`, `AttributeModifierHelper.java`, `ParticlePlacement`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `Attack` connect `Attack` to `PlayerAttackHelper`, `MinecraftClient_DinamycCombat`, `ParticlePlacement`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `AttackHand` connect `PlayerAttackHelper` to `Attack`, `MinecraftClient_DinamycCombat`?**
